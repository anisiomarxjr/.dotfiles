...
-- Dzen/Conky
myXmonadBar = "dzen2 -fn 'Inconsolata' -x '0' -y '0' -h '20' -w '640' -ta 'l' -fg '#FFFFFF' -bg '#1B1D1E'"
myStatusBar = "conky -c /home/anisio/.xmonad/.conky_dzen | dzen2 -fn 'Inconsolata' -x '640' -w '512' -h '20' -ta 'r' -bg '#1B1D1E' -fg '#FFFFFF' -y '0'"
myTray = "trayer --edge top --align right --SetDockType true --SetPartialStrut true --expand true --widthtype pixel --width 128 --transparent true --alpha 0 --tint 0xFD971F --heighttype pixel --height 20"
myBitmapsDir = "/home/anisio/.xmonad/dzen2"
--}}}
-- Main {{{
main = do
    dzenLeftBar <- spawnPipe myXmonadBar
    dzenRightBar <- spawnPipe myStatusBar
    dzenCenterBar <- spawnPipe myTray
...
-- }}}
layoutHook'  =  onWorkspaces ["2","3","4","5","6"] customLayout2 $ 
                onWorkspaces ["6"] gimpLayout $ 
                onWorkspaces ["1","7"] imLayout $
                customLayout2
...
barFont  = "xft: inconsolata-10"
barXFont = "xft: inconsolata-12"
...
keys' conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
    ...
    , ((modMask .|. shiftMask,      xK_z        ), spawn "setxkbmap us")
    , ((modMask .|. shiftMask,      xK_x        ), spawn "setxkbmap br")
